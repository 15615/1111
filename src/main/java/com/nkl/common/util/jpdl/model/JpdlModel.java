 ...
 * @description
 */
package com.nkl.common.util.jpdl.model;
...
import com.nkl.common.util.jpdl.util.InputStreamUtil;
...
public class JpdlModel {
	...
	public JpdlModel(String is) throws Exception {
		this(new SAXReader().read(InputStreamUtil.StringTOInputStream(is)).getRootElement());
	}
